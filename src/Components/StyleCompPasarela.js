...
export const ContainerPasarela = styled.div`
    width: 80%;
    height: 80%;
...
export const ContiarnetDatos = styled.div`
    padding: 20px;
...
export const ContainerMetodoPago = styled.div`
    display: flex;
    justify-content: space-between;
`

export const DivMetodoPago = styled.div`
    padding: 10px;
...
export const ImagenMetodoPago = styled.img`
    width: 80px; 
    height: 30px;
    object-fit: contain;
`
